...
public class DisponibilidadeService {
    ...
    public ApiResponse<DisponibilidadeResponseDTO> registrarDisponibilidade(
        ...
        List<Disponibilidade> disponibilidadesExistentes =
                disponibilidadeRepository.findByMedicoAndDiaSemana(
                        medico,
        ...
        for (Disponibilidade disponibilidadeExistente : disponibilidadesExistentes) {
            ...
            boolean possuiConflito =
                    disponibilidadeRequestDTO.horarioInicio()
        ...
        Disponibilidade disponibilidade =
                DisponibilidadeMapper.toEntityDisponibilidade(
        ...
        DisponibilidadeResponseDTO dto =
                DisponibilidadeMapper
                        .toDisponibilidadeResponseDTO(disponibilidade);

        return new ApiResponse<>(dto);
    }

    public ApiResponse<List<DisponibilidadeResponseDTO>>
            listarDisponibilidadesPorMedico(Long medicoId) {

        Medico medico = medicoRepository.findById(medicoId)
                .orElseThrow(() -> new RuntimeException("Médico não encontrado"));

        List<DisponibilidadeResponseDTO> lista =
                disponibilidadeRepository.findByMedico(medico)
                        .stream()
