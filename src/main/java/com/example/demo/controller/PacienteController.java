...
import org.springframework.web.bind.annotation.RequestParam;
 ...
 public class PacienteController {
    ...
    @GetMapping
    public ResponseEntity<ApiResponse<List<PacienteResponseDTO>>> listarTodos(@RequestParam(required = false) Integer page,
    ...
    public ResponseEntity<ApiResponse<String>> removerPaciente(@PathVariable Long id) {
        ...
        if (!response.isSuccess()) {
            var status = response.getError().getError().equals("Forbidden") ? HttpStatus.FORBIDDEN : HttpStatus.NOT_FOUND;
